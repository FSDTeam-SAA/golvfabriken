    ...
    return [
      {
        ...
        title: t('checkout.steps.addresses.title'),
        description: t('checkout.steps.addresses.description'),
        completed: !!(cart?.shipping_address && cart?.billing_address),
      },
      {
        key: CheckoutStepKey.DELIVERY,
        title: t('checkout.steps.delivery.title'),
        description: t('checkout.steps.delivery.description'),
      ...
      },
      {
        ...
        title: t('checkout.steps.review.title'),
        description: t('checkout.steps.review.description'),
        completed: false,
      },
    ]
  }, [cart, t])
    ...
    <div className="content-container py-8 flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-24">
        ...
        <div className="flex flex-col gap-1">
          <h2 className="text-zinc-900 text-xl">{t('checkout.summary.orderSummary')}</h2>
        </div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-24">
