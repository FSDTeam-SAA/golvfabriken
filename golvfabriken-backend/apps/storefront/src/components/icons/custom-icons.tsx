// Custom icon components for icons not available in @medusajs/icons

interface IconProps {
  className?: string;
}

export function BuildingOffice({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
...
export function Calculator({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function Truck({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function Shield({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
